...
function Section7() {
  ...
  return (
    <section className={`relative flex flex-col justify-center items-center overflow-hidden py-10 ${
      darkMode ? "bg-gray-800" : "bg-white"
    }`}>
      <main className="flex flex-col md:flex-row w-full max-w-8xl mx-auto">
        {/* Left Section */}
        <div
          className={`w-full md:w-1/2 h-[250px] md:h-[500px] ${
        ...
        >
          ...
          <p data-aos="fade-up" className={`text-[11px] sm:text-[13px] md:text-sm mb-4 ${
